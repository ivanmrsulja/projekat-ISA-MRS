Vue.component("register-pharmacist", {
	data: function () {
		    return {
		...
		<table>
			...
			<tr>
				<td align=center colspan=2> 
					<input value="Registruj farmaceuta" type="button" name="regBtn" v-on:click="registerPharmacist()"/> 
				</td>
			</tr>
		</table>
		</div>
...
`
	...
	methods : {
		registerPharmacist : function () {
            ...
            let pocetakRadnogVremena = $("input[name=pocetakRV]").val();
            let krajRadnogVremena = $("input[name=krajRV]").val();
			...
			let newUser = {username: usr, noviPassw: pas, ime: ime, prezime : prz, email: email, telefon: tel, lokacija: lok, pocetakRadnogVremena: pocetakRadnogVremena, krajRadnogVremena: krajRadnogVremena};
